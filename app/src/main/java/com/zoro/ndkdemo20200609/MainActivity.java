package com.zoro.ndkdemo20200609;
...
import com.zoro.ndkdemo20200609.draw.DrawHelper;
import com.zoro.ndkdemo20200609.draw.DrawInfo;
import com.zoro.ndkdemo20200609.draw.FaceRectView;
import com.zoro.ndkdemo20200609.glsurface.GLUtil;
import com.zoro.ndkdemo20200609.glsurface.RtmpGLSurfaceView;
...
//                rtmp://202.69.69.180:443/webcast/bshdlive-pc
                ...
                RtmpPlayer.getInstance().nativeSetCallback(new PlayCallback() {
                    ...
                    public void onPrepared(int width, int height) {
                        Log.i(TAG, "RtmpPlayeronPrepared: width==" + width+"  height=="+height);
                        //获得数据流的宽高
                        frameWidth = width;
                        frameHeight = height;
                    ...
                    public void onFrameAvailable(byte[] data) {
                        //获得裸数据，裸数据的格式为NV21
                        Log.i(TAG, "RtmpPlayeronFrameAvailable: " + Arrays.hashCode(data));
